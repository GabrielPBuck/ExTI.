...
namespace ExTI.Controllers
{
    public class CadClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCliente,NomeCliente,Sobrenome,Telefone,CPF")] CadClientes cadClientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,NomeCliente,Sobrenome,Telefone,CPF")] CadClientes cadClientes)
        {
